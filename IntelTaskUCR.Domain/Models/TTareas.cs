...
public partial class TTareas
{
    ...
    public virtual TUsuarios? CnUsuarioAsignadoNavigation { get; set; }
    ...
    public virtual ICollection<TTareasIncumplimientos> TTareasIncumplimientos { get; set; } = new List<TTareasIncumplimientos>();
